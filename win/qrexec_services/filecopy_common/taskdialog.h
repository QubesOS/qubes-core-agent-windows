...
typedef WINCOMMCTRLAPI HRESULT WINAPI TaskDialogIndirectProc(const TASKDIALOGCONFIG *pTaskConfig, int *pnButton, int *pnRadioButton, BOOL *pfVerificationFlagChecked);
